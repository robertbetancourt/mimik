...
export function BottomSheet({ visible, onClose, children, footer }: BottomSheetProps) {
  ...
  const backdropStyle = useAnimatedStyle(() => ({ opacity: backdropProgress.value * SCRIM_OPACITY }));
  ...
  return (
    <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0 }}>
      <Animated.View style={[{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0 }, blurStyle]}>
